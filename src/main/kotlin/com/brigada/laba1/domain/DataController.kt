...
class DataController(
    ...
    suspend fun addFilm(film: AddingFIlm) = dataRepository.addFilm(film.toData(getAllData().last().id + 1))
    suspend fun deleteFilm(id: Long): Boolean = dataRepository.deleteFIlm(id)
    suspend fun getById(id: Long) = dataRepository.getFilm(id)
